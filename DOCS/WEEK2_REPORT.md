...
We used STM32CubeProgrammer to download the LED code to the MCU, but even that stopped working after a while, it gave the same error about the outdated firmware for the ST-LINK.
